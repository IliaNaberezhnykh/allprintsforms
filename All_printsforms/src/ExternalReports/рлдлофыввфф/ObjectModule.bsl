...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ОбщееОписание = "БИТ Заказы покупателей за период+заказы поставщикам новый";
     
    ПараметрыРегистрации  = Новый Структура;
    ПараметрыРегистрации.Вставить("Вид"             , "ДополнительныйОтчет"); 
    ПараметрыРегистрации.Вставить("БезопасныйРежим" , Ложь);
     
	ПараметрыРегистрации.Вставить("Представление", НСтр("ru = 'БИТ Заказы покупателей за период+заказы поставщикам новый'"));
 	ПараметрыРегистрации.Вставить("Наименование", НСтр("ru = 'БИТ Заказы покупателей за период+заказы поставщикам новый'"))  ;
