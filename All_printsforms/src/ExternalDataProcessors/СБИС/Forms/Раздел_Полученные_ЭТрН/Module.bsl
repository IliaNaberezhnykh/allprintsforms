...
Функция ОбновитьКонтент(Кэш) Экспорт 
	...
	Для Индекс = 0 По СтруктураДляОбновленияФормы.Таблица_РеестрСобытий.ВГраница() Цикл
		Стороны = СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].СоставПакета[0].Значение.Стороны;
		Если Стороны.Свойство("Заказчик") Тогда
			СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].Вставить("Заказчик", Кэш.ОбщиеФункции.СбисНазваниеСтороны(Стороны.Заказчик));
		КонецЕсли;
		Если Стороны.Свойство("Перевозчик") Тогда
			СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].Вставить("Перевозчик", Кэш.ОбщиеФункции.СбисНазваниеСтороны(Стороны.Перевозчик));
		КонецЕсли;
		Если Стороны.Свойство("Отправитель") Тогда
			СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].Вставить("Контрагент", Кэш.ОбщиеФункции.СбисНазваниеСтороны(Стороны.Отправитель));
		КонецЕсли;
		Если Стороны.Свойство("Получатель") Тогда
			СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].Вставить("НашаОрганизация", Кэш.ОбщиеФункции.СбисНазваниеСтороны(Стороны.Получатель));
		КонецЕсли;
		Если СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].СоставПакета[0].Значение.Свойство("ТекущиеЭтапы") Тогда
			СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].Вставить("ТекущийЭтап", СтруктураДляОбновленияФормы.Таблица_РеестрСобытий[Индекс].СоставПакета[0].Значение.ТекущиеЭтапы[0].Наименование);
		КонецЕсли;
	КонецЦикла;
