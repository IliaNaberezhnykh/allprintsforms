...
Функция СформироватьДокументДляГенератора(Кэш, Док, Контекст, Вложение) Экспорт
	...
	Файл_Шаблон.ЗаполнитьПоДокументПараметр(Кэш,  ТекДокумент);
	Файл_Шаблон.ЗаполнитьПоДокументОснование(Кэш, ТекДокумент);
	...
	Файл_Шаблон.СформироватьПараметры(Кэш, ТекДокумент);
